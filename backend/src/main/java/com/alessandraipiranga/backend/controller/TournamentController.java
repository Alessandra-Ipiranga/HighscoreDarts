...
@Setter
@CrossOrigin
@Tag(name = TournamentController.TOURNAMENT_CONTROLLER_TAG, description = "Provides CRUD operations for a Entity")
...
public class TournamentController {
    ...
    public ResponseEntity<Tournament> createTournament(@RequestBody Tournament tournament) {
        TournamentEntity createdTournamentEntity = tournamentService.createTournament(tournament.getRounds(), tournament.getGroups());
